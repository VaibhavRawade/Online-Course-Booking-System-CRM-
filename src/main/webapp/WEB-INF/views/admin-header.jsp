...
<html>
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>CRM Application - Admin</title>
...
<a href="homepage" class="fs-4" style="color: black; text-decoration: none; border: 2px solid black; padding: 5px 10px; display: inline-block;background-color: white">CRM Application</a>
                ...
                <div class="col-3 text-end">
                    <div class="btn-group">
                       ...
                       <a href="loginpage" class="text-black ms-3 fs-5" style="background-color:red; color:white; padding:5px 10px; border-radius:5px; text-decoration:none; font-weight:bold; transition: background-color 0.3s;margin-right: 50px;"> Logout</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="addprd">Add Course</a></li>
                            <li><a class="dropdown-item" href="listprd">Course's List</a></li>
                        </ul>
                    </li>

                    <!-- Course Purchased Customers -->
                    <li class="nav-item">
                        <a class="nav-link" href="purchasedCustomer">Course Purchased Customers</a>
                    </li>
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="onlineCourses">Available Courses</a>
                    </li>
